...
class MainActivity : AppCompatActivity(){
    ...
    private fun showPdf(url: String?) {
        ...
        Log.i("PDF", "LevantamientoPdf")
        binding.webViewPdf.settings.javaScriptEnabled = true
        binding.webViewPdf.settings.loadWithOverviewMode = true
        binding.webViewPdf.settings.useWideViewPort = true
