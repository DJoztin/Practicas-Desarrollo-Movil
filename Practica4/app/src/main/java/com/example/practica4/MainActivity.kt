...
class MainActivity : AppCompatActivity() {
    ...
    private val caras = listOf(R.drawable.a1, R.drawable.a2, R.drawable.a3, R.drawable.a4)
    private val cuerpos = listOf(R.drawable.b1, R.drawable.b2, R.drawable.b3, R.drawable.b4)
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Enlazar los adaptadores a los spinners
