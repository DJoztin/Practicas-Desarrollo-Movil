...
class ContadorWidgetProvider: AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent){
        ...
        when(intent.action){
            ACTION_APP_EVENT -> {
                // Acciones a realizar cuando se recibe el evento de la app
    ...
    private fun actualizarWidget(context: Context, manager: AppWidgetManager, id: Int){
        ...
        val views = RemoteViews(context.packageName, R.layout.widget_contador)
    ...
    companion object{
        const val ACTION_APP_EVENT = "com.example.Practica9.ACTION_APP_EVENT"
