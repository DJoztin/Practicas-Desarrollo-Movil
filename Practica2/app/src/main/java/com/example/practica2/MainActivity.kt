...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rbBasico = findViewById(R.id.radioButton)
        rbIntermedio = findViewById(R.id.radioButton2)
        rbAvanzado = findViewById(R.id.radioButton3)
        ...
        rgNivel.setOnCheckedChangeListener {
            ...
            val nivel = when (checkedId){
                R.id.radioButton -> "Basico"
                R.id.radioButton2 -> "Intermedio"
                R.id.radioButton3 -> "Avanzado"
                else-> "Ninguno"

            }
            Log.i("Nivel","Nicel cambio a $nivel" )
        }
        ...
        btnVerSeleccion.setOnClickListener {
            ...
            Toast.makeText(this, "Leido", Toast.LENGTH_LONG).show()
            ...
            savedInstanceState?.let{
                ...
                tvResultado.text = state.getString("resultado", "Resultado aparece aqui:")
            }
    ...
    override fun onSaveInstanceState(outState: Bundle){
        ...
        outState.putInt("nivelCheckedId", rgNivel.checkedRadioButtonId)
